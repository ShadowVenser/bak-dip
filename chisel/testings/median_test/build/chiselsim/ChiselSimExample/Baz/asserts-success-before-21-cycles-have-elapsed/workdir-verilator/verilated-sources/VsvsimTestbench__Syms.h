...
using VsvsimTestbench__Vcb_getBitWidthImpl_success_t = void (*) (VsvsimTestbench__Syms* __restrict vlSymsp, IData/*31:0*/ &value);
...
using VsvsimTestbench__Vcb_getBitsImpl_success_t = void (*) (VsvsimTestbench__Syms* __restrict vlSymsp, CData/*0:0*/ &value_success);
