...
#endif
            VL_FATAL_MT("/home/venser/bak-dip/chisel/testings/median_test/build/chiselsim/ChiselSimExample/Baz/asserts-success-before-21-cycles-have-elapsed/primary-sources/../generated-sources/testbench.sv", 1, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void VsvsimTestbench___024root___ctor_var_reset(VsvsimTestbench___024root* vlSelf) {
    ...
    vlSelf->svsimTestbench__DOT__success = VL_RAND_RESET_I(1);
    vlSelf->svsimTestbench__DOT__simulationState = 0;
    vlSelf->svsimTestbench__DOT__dut__DOT__done_c_value = VL_RAND_RESET_I(5);
