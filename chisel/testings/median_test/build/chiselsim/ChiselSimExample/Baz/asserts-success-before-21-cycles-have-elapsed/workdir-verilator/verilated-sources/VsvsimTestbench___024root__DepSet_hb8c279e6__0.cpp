...
void VsvsimTestbench___024root____Vdpiexp_svsimTestbench__DOT__getBitWidthImpl_success_TOP(VsvsimTestbench__Syms* __restrict vlSymsp, IData/*31:0*/ &value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VsvsimTestbench___024root____Vdpiexp_svsimTestbench__DOT__getBitWidthImpl_success_TOP\n"); );
    // Init
    // Body
    value = 1U;
}

void VsvsimTestbench___024root____Vdpiexp_svsimTestbench__DOT__getBitsImpl_success_TOP(VsvsimTestbench__Syms* __restrict vlSymsp, CData/*0:0*/ &value_success) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VsvsimTestbench___024root____Vdpiexp_svsimTestbench__DOT__getBitsImpl_success_TOP\n"); );
    // Init
    // Body
    value_success = (0x13U == (IData)(vlSymsp->TOP.svsimTestbench__DOT__dut__DOT__done_c_value));
}
...
VL_INLINE_OPT void VsvsimTestbench___024root___act_sequent__TOP__0(VsvsimTestbench___024root* vlSelf) {
    ...
    if ((1U == vlSelf->svsimTestbench__DOT__simulationState)) {
        VsvsimTestbench___024root____Vdpiimwrap_svsimTestbench__DOT__simulation_body_TOP(
                                                                                ...
                                                                                "/home/venser/bak-dip/chisel/testings/median_test/build/chiselsim/ChiselSimExample/Baz/asserts-success-before-21-cycles-have-elapsed/primary-sources/../generated-sources/testbench.sv", 0x44U);
