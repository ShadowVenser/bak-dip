...
using VsvsimTestbench__Vcb_getBitWidthImpl_c_t = void (*) (VsvsimTestbench__Syms* __restrict vlSymsp, IData/*31:0*/ &value);
...
using VsvsimTestbench__Vcb_getBitsImpl_a_t = void (*) (VsvsimTestbench__Syms* __restrict vlSymsp, CData/*7:0*/ &value_a);
using VsvsimTestbench__Vcb_getBitsImpl_b_t = void (*) (VsvsimTestbench__Syms* __restrict vlSymsp, CData/*7:0*/ &value_b);
using VsvsimTestbench__Vcb_getBitsImpl_c_t = void (*) (VsvsimTestbench__Syms* __restrict vlSymsp, CData/*7:0*/ &value_c);
...
using VsvsimTestbench__Vcb_setBitsImpl_a_t = void (*) (VsvsimTestbench__Syms* __restrict vlSymsp, CData/*7:0*/ value_a);
using VsvsimTestbench__Vcb_setBitsImpl_b_t = void (*) (VsvsimTestbench__Syms* __restrict vlSymsp, CData/*7:0*/ value_b);
