...
VL_ATTR_COLD void VsvsimTestbench___024root___eval_static__TOP(VsvsimTestbench___024root* vlSelf) {
    ...
    // Body
    vlSelf->svsimTestbench__DOT__clk = 0U;
    vlSelf->svsimTestbench__DOT__clr_n = 0U;
    vlSelf->svsimTestbench__DOT__x1 = 0U;
    vlSelf->svsimTestbench__DOT__x2 = 0U;
    vlSelf->svsimTestbench__DOT__addr = 0U;
...
#endif
            VL_FATAL_MT("/home/venser/bak-dip/chisel/testings/example/build/chiselsim/MuxTest/Sync-MUX/Basic-MUX-test/primary-sources/../generated-sources/testbench.sv", 1, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void VsvsimTestbench___024root___dump_triggers__act(VsvsimTestbench___024root* vlSelf) {
    ...
    if ((4ULL & vlSelf->__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 2 is active: @(posedge svsimTestbench.clk or posedge svsimTestbench.dut._asyncReset_T)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void VsvsimTestbench___024root___dump_triggers__nba(VsvsimTestbench___024root* vlSelf) {
    ...
    if ((4ULL & vlSelf->__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 2 is active: @(posedge svsimTestbench.clk or posedge svsimTestbench.dut._asyncReset_T)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void VsvsimTestbench___024root___ctor_var_reset(VsvsimTestbench___024root* vlSelf) {
    ...
    // Body
    vlSelf->svsimTestbench__DOT__clk = VL_RAND_RESET_I(1);
    vlSelf->svsimTestbench__DOT__clr_n = VL_RAND_RESET_I(1);
    vlSelf->svsimTestbench__DOT__x1 = VL_RAND_RESET_I(16);
    vlSelf->svsimTestbench__DOT__x2 = VL_RAND_RESET_I(16);
    ...
    vlSelf->__Vtrigprevexpr___TOP__svsimTestbench__DOT__clk__0 = VL_RAND_RESET_I(1);
    vlSelf->__Vtrigprevexpr___TOP__svsimTestbench__DOT__dut__DOT___asyncReset_T__0 = VL_RAND_RESET_I(1);
