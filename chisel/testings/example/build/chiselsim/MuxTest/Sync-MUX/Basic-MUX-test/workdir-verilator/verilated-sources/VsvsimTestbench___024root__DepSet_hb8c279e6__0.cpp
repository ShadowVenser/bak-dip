...
void VsvsimTestbench___024root____Vdpiexp_svsimTestbench__DOT__getBitWidthImpl_clk_TOP(VsvsimTestbench__Syms* __restrict vlSymsp, IData/*31:0*/ &value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VsvsimTestbench___024root____Vdpiexp_svsimTestbench__DOT__getBitWidthImpl_clk_TOP\n"); );
    // Init
    // Body
    value = 1U;
}

void VsvsimTestbench___024root____Vdpiexp_svsimTestbench__DOT__setBitsImpl_clk_TOP(VsvsimTestbench__Syms* __restrict vlSymsp, CData/*0:0*/ value_clk) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VsvsimTestbench___024root____Vdpiexp_svsimTestbench__DOT__setBitsImpl_clk_TOP\n"); );
    // Init
    // Body
    vlSymsp->TOP.__Vdpi_export_trigger = 1U;
    vlSymsp->TOP.svsimTestbench__DOT__clk = value_clk;
}

void VsvsimTestbench___024root____Vdpiexp_svsimTestbench__DOT__getBitsImpl_clk_TOP(VsvsimTestbench__Syms* __restrict vlSymsp, CData/*0:0*/ &value_clk) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VsvsimTestbench___024root____Vdpiexp_svsimTestbench__DOT__getBitsImpl_clk_TOP\n"); );
    // Init
    // Body
    value_clk = vlSymsp->TOP.svsimTestbench__DOT__clk;
}

void VsvsimTestbench___024root____Vdpiexp_svsimTestbench__DOT__getBitWidthImpl_clr_n_TOP(VsvsimTestbench__Syms* __restrict vlSymsp, IData/*31:0*/ &value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VsvsimTestbench___024root____Vdpiexp_svsimTestbench__DOT__getBitWidthImpl_clr_n_TOP\n"); );
    // Init
    // Body
    value = 1U;
}

void VsvsimTestbench___024root____Vdpiexp_svsimTestbench__DOT__setBitsImpl_clr_n_TOP(VsvsimTestbench__Syms* __restrict vlSymsp, CData/*0:0*/ value_clr_n) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VsvsimTestbench___024root____Vdpiexp_svsimTestbench__DOT__setBitsImpl_clr_n_TOP\n"); );
    // Init
    // Body
    vlSymsp->TOP.__Vdpi_export_trigger = 1U;
    vlSymsp->TOP.svsimTestbench__DOT__clr_n = value_clr_n;
}

void VsvsimTestbench___024root____Vdpiexp_svsimTestbench__DOT__getBitsImpl_clr_n_TOP(VsvsimTestbench__Syms* __restrict vlSymsp, CData/*0:0*/ &value_clr_n) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VsvsimTestbench___024root____Vdpiexp_svsimTestbench__DOT__getBitsImpl_clr_n_TOP\n"); );
    // Init
    // Body
    value_clr_n = vlSymsp->TOP.svsimTestbench__DOT__clr_n;
}
...
void VsvsimTestbench___024root____Vdpiexp_svsimTestbench__DOT__setBitsImpl_x1_TOP(VsvsimTestbench__Syms* __restrict vlSymsp, SData/*15:0*/ value_x1) {
...
void VsvsimTestbench___024root____Vdpiexp_svsimTestbench__DOT__getBitsImpl_x1_TOP(VsvsimTestbench__Syms* __restrict vlSymsp, SData/*15:0*/ &value_x1) {
...
void VsvsimTestbench___024root____Vdpiexp_svsimTestbench__DOT__setBitsImpl_x2_TOP(VsvsimTestbench__Syms* __restrict vlSymsp, SData/*15:0*/ value_x2) {
...
void VsvsimTestbench___024root____Vdpiexp_svsimTestbench__DOT__getBitsImpl_x2_TOP(VsvsimTestbench__Syms* __restrict vlSymsp, SData/*15:0*/ &value_x2) {
...
void VsvsimTestbench___024root____Vdpiexp_svsimTestbench__DOT__getBitWidthImpl_addr_TOP(VsvsimTestbench__Syms* __restrict vlSymsp, IData/*31:0*/ &value) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VsvsimTestbench___024root____Vdpiexp_svsimTestbench__DOT__getBitWidthImpl_addr_TOP\n"); );
    // Init
    // Body
    value = 1U;
}

void VsvsimTestbench___024root____Vdpiexp_svsimTestbench__DOT__setBitsImpl_addr_TOP(VsvsimTestbench__Syms* __restrict vlSymsp, CData/*0:0*/ value_addr) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VsvsimTestbench___024root____Vdpiexp_svsimTestbench__DOT__setBitsImpl_addr_TOP\n"); );
    // Init
    // Body
    vlSymsp->TOP.__Vdpi_export_trigger = 1U;
    vlSymsp->TOP.svsimTestbench__DOT__addr = value_addr;
}

void VsvsimTestbench___024root____Vdpiexp_svsimTestbench__DOT__getBitsImpl_addr_TOP(VsvsimTestbench__Syms* __restrict vlSymsp, CData/*0:0*/ &value_addr) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VsvsimTestbench___024root____Vdpiexp_svsimTestbench__DOT__getBitsImpl_addr_TOP\n"); );
    // Init
    // Body
    value_addr = vlSymsp->TOP.svsimTestbench__DOT__addr;
}
...
void VsvsimTestbench___024root____Vdpiexp_svsimTestbench__DOT__getBitsImpl_y_TOP(VsvsimTestbench__Syms* __restrict vlSymsp, SData/*15:0*/ &value_y) {
...
void VsvsimTestbench___024root___eval_triggers__act(VsvsimTestbench___024root* vlSelf) {
    ...
    vlSelf->__VactTriggered.set(2U, (((IData)(vlSelf->svsimTestbench__DOT__clk) 
                                      & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__svsimTestbench__DOT__clk__0))) 
                                     | ((IData)(vlSelf->svsimTestbench__DOT__dut__DOT___asyncReset_T) 
                                        & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__svsimTestbench__DOT__dut__DOT___asyncReset_T__0)))));
    vlSelf->__Vtrigprevexpr___TOP__svsimTestbench__DOT__simulationState__0 
        = vlSelf->svsimTestbench__DOT__simulationState;
    vlSelf->__Vtrigprevexpr___TOP__svsimTestbench__DOT__clk__0 
        = vlSelf->svsimTestbench__DOT__clk;
    vlSelf->__Vtrigprevexpr___TOP__svsimTestbench__DOT__dut__DOT___asyncReset_T__0 
...
VL_INLINE_OPT void VsvsimTestbench___024root___act_sequent__TOP__1(VsvsimTestbench___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VsvsimTestbench__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VsvsimTestbench___024root___act_sequent__TOP__1\n"); );
    // Body
    if ((1U == vlSelf->svsimTestbench__DOT__simulationState)) {
        VsvsimTestbench___024root____Vdpiimwrap_svsimTestbench__DOT__simulation_body_TOP(
                                                                                ...
                                                                                "/home/venser/bak-dip/chisel/testings/example/build/chiselsim/MuxTest/Sync-MUX/Basic-MUX-test/primary-sources/../generated-sources/testbench.sv", 0x7dU);
