...
VL_INLINE_OPT void VsvsimTestbench___024root___nba_sequent__TOP__0(VsvsimTestbench___024root* vlSelf) {
    ...
    vlSelf->svsimTestbench__DOT__dut__DOT__done_c_value 
        = ((IData)(vlSelf->svsimTestbench__DOT__reset)
            ? 0U : ((IData)(vlSelf->svsimTestbench__DOT__success)
                     ? 0U : (0x1fU & ((IData)(1U) + (IData)(vlSelf->svsimTestbench__DOT__dut__DOT__done_c_value)))));
    vlSelf->svsimTestbench__DOT__success = (0x13U == (IData)(vlSelf->svsimTestbench__DOT__dut__DOT__done_c_value));
}
...
#endif
            VL_FATAL_MT("/home/venser/bak-dip/chisel/testings/median_test/build/chiselsim/ChiselSimExample/Baz/asserts-success-before-21-cycles-have-elapsed/primary-sources/../generated-sources/testbench.sv", 1, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("/home/venser/bak-dip/chisel/testings/median_test/build/chiselsim/ChiselSimExample/Baz/asserts-success-before-21-cycles-have-elapsed/primary-sources/../generated-sources/testbench.sv", 1, "", "Active region did not converge.");
            }
