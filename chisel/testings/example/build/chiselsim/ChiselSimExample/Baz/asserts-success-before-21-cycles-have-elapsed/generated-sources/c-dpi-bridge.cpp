...
void getBitWidth_success(int* result) {
           svScope prev = setScopeToTestBench();
           getBitWidthImpl_success(result);
           svSetScope(prev);
        }
void getBits_success(svBitVecVal* result) {
           svScope prev = setScopeToTestBench();
           getBitsImpl_success(result);
           svSetScope(prev);
        }
  ...
  switch (id) {
    ...
    case 1: // reset
      ...
      *getter = (void(*)(uint8_t*))getBits_reset;
      return 0;
    case 2: // success
      getBitWidth_success(bitWidth);
      *getter = (void(*)(uint8_t*))getBits_success;
      return 0;
    default:
      return -1;
  }
