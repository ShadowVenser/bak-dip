...
class alignas(VL_CACHE_LINE_BYTES) VsvsimTestbench VL_NOT_FINAL : public VerilatedModel {
  ...
  public:
    ...
    static void getBitWidthImpl_a(int* value);
    static void getBitWidthImpl_b(int* value);
    static void getBitWidthImpl_c(int* value);
    static void getBitWidthImpl_clock(int* value);
    static void getBitWidthImpl_reset(int* value);
    static void getBitsImpl_a(svBitVecVal* value_a);
    static void getBitsImpl_b(svBitVecVal* value_b);
    static void getBitsImpl_c(svBitVecVal* value_c);
    static void getBitsImpl_clock(svBitVecVal* value_clock);
    static void getBitsImpl_reset(svBitVecVal* value_reset);
    static void setBitsImpl_a(const svBitVecVal* value_a);
    static void setBitsImpl_b(const svBitVecVal* value_b);
